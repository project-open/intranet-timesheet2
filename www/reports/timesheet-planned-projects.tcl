...
if {"" == $start_date} { 
    set start_date [db_string get_today "select to_char(sysdate - interval '2 months',:date_format) from dual"]   
}
...
ad_form -extend -name $form_id -form {
    ...
    {view_type:text(select) {label "Type"} {options {{Planning planning} {Forecast forecast}}} {value $view_type}}
