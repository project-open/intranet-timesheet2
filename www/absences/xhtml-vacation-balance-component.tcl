...
ad_page_contract {
    Shows the vacation balance for the user.
...
if {!$read_p} { 
    ns_return 200 text/html [lang::message::lookup "" intranet-core.InsufficientPermissionsContent "You have insufficient permissions to view this content."] 
}
